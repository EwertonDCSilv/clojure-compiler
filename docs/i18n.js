...
(() => {
  ...
  const messages = {
    pt: {
      ...
      "benchmarks.lead":
        "Compare os 98 programas com a mesma carga e checksums idênticos. Escolha a suíte e alterne entre tempo, CPU e memória sem sair da página.",
      ...
      "benchmarks.chartTitle": "{suite} · {metric}",
      "benchmarks.legendLabel": "Legenda do gráfico",
      "benchmarks.legendNativeFaster": "Nativo mais rápido",
      "benchmarks.legendJvmFaster": "JVM mais rápida",
      "benchmarks.legendNative": "Nativo",
      "benchmarks.legendJvm": "Clojure/JVM",
    ...
    es: {
      ...
      "benchmarks.lead":
        "Compara los 98 programas con la misma carga y checksums idénticos. Elige la suite y alterna entre tiempo, CPU y memoria sin salir de la página.",
      ...
      "benchmarks.openCsv": "Ver CSV",
      "benchmarks.chartTitle": "{suite} · {metric}",
      "benchmarks.legendLabel": "Leyenda del gráfico",
      "benchmarks.legendNativeFaster": "Nativo más rápido",
      "benchmarks.legendJvmFaster": "JVM más rápida",
      "benchmarks.legendNative": "Nativo",
      "benchmarks.legendJvm": "Clojure/JVM",
    ...
    en: {
      ...
      "benchmarks.lead":
        "Compare all 98 programs under the same load with matching checksums. Choose a suite and switch between wall time, CPU, and memory without leaving the page.",
      "benchmarks.suiteLabel": "Suite",
      ...
      "benchmarks.chartTitle": "{suite} · {metric}",
      "benchmarks.legendLabel": "Chart legend",
      "benchmarks.legendNativeFaster": "Native faster",
      "benchmarks.legendJvmFaster": "JVM faster",
      "benchmarks.legendNative": "Native",
      "benchmarks.legendJvm": "Clojure/JVM",
    ...
    fr: {
      ...
      "benchmarks.lead":
        "Comparez les 98 programmes avec la même charge et des checksums identiques. Choisissez une suite et alternez entre temps d’exécution, CPU et mémoire sans quitter la page.",
      "benchmarks.suiteLabel": "Suite",
      ...
      "benchmarks.chartTitle": "{suite} · {metric}",
      "benchmarks.legendLabel": "Légende du graphique",
      "benchmarks.legendNativeFaster": "Natif plus rapide",
      "benchmarks.legendJvmFaster": "JVM plus rapide",
      "benchmarks.legendNative": "Natif",
      "benchmarks.legendJvm": "Clojure/JVM",
    ...
    ru: {
      ...
      "benchmarks.lead":
        "Сравните 98 программ с одинаковой нагрузкой и совпадающими контрольными суммами. Выбирайте набор и переключайтесь между временем, CPU и памятью прямо на странице.",
      ...
      "benchmarks.chartTitle": "{suite} · {metric}",
      "benchmarks.legendLabel": "Легенда графика",
      "benchmarks.legendNativeFaster": "Native быстрее",
      "benchmarks.legendJvmFaster": "JVM быстрее",
      "benchmarks.legendNative": "Native",
      "benchmarks.legendJvm": "Clojure/JVM",
    ...
    ch: {
      ...
      "benchmarks.lead":
        "在相同负载和一致校验和下比较全部 98 个程序。无需离开页面，即可选择套件并切换时间、CPU 和内存指标。",
      ...
      "benchmarks.chartTitle": "{suite} · {metric}",
      "benchmarks.legendLabel": "图表图例",
      "benchmarks.legendNativeFaster": "原生更快",
      "benchmarks.legendJvmFaster": "JVM 更快",
      "benchmarks.legendNative": "原生",
      "benchmarks.legendJvm": "Clojure/JVM",
